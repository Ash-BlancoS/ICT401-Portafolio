...
Copie esta plantilla a `Portafolio/semana09/` y guárdela como `S09_Registro_Blanco_Ashley.md`. Sustituya `Apellido_Nombre` por un apellido y un nombre sin espacios ni tildes. Complete cada `[Respuesta]`, agregue las imágenes solicitadas en la misma carpeta y haga commit.
...
![P3: Modelo final](S09_P3_Modelo_Blanco_Ashley.png)

Montaje de Front, Top y Right del modelo para compararlos con el plano.

![P3: Vistas](S09_P3_Vistas_Blanco_Ashley.png)

Captura de una comprobación dimensional con `Inspect > Measure`.

![P3: Medicion](S09_P3_Medicion_Blanco_Ashley.png)
...
Corrección posterior: `S09 correccion Fusion Blanco Ashley`.
