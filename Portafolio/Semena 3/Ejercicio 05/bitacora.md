...
3. Realice una corrección viable y vuelva a comprobar el resultado.
4. Guarde una versión con la descripción V4-- Variante revisada.
5. Realice una captura donde se observe el boceto final y el navegador.
6. Escriba en bitacora.md entre 60 y 90 palabras para responder:
